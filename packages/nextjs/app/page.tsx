  ...
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-[linear-gradient(135deg,_#050505_0%,_#111111_50%,_#050505_100%)] px-4">
      ...
      <section className="relative z-10 mx-auto max-w-4xl px-8 py-14 text-center">
        <Image
          alt="BlindLend logo"
          className="mx-auto mb-7 h-24 w-24 rounded-full border border-amber-300"
          height={96}
          src="/blindlend-logo.svg"
          width={96}
        />
        <h1 className="text-5xl font-black tracking-tight text-white md:text-6xl">your credit score is not Zero,</h1>
